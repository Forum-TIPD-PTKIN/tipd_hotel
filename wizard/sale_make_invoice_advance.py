...
class SaleAdvancePaymentInv(models.TransientModel):
    ...
    def create_invoices(self):
        ...
        if self._context.get("active_model") == "tipd_hotel.folio":
            HotelFolio = self.env["tipd_hotel.folio"]
    ...
    def default_get(self, fields):
        ...
        if self.env.context.get("active_model") == "tipd_hotel.folio":
            active_id = self.env.context.get("active_id")
            folio_id = self.env["tipd_hotel.folio"].browse(active_id)
